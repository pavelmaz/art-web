        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
          <aside className="order-2 w-full lg:w-96">
            <div className="glass-surface space-y-4 rounded-2xl p-5 lg:sticky lg:top-6">
              ...
              <div className="mt-4">
                <ArtworkActions artworkId={artwork.id} locale="en" />
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between gap-2 rounded-lg glass-inset p-3">
                  ...
                  <DownloadButton imageUrl={downloadImageUrl} filename={artwork.slug} title={artwork.title} maxWidth={artwork.img_width ?? null} variant="glass" />
                </div>
              ...
              <Link
                ...
                className="glass-chip inline-flex items-center gap-1 whitespace-nowrap rounded-full px-2 py-1 text-[11px] transition-colors hover:bg-white/60"
              >
          ...
          <ArtworkInsightsProvider artwork={artwork} locale="en">
