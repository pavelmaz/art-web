...
export const metadata: Metadata = {
  title: "Fine Art Free — Descarga 500.000+ Œuvres d\'art de Dominio Público",
  description:
    "Explora y descarga 500.000+ pinturas clásicas gratis. Arte de dominio público de los mejores musées del mundo. Gratis para uso personal y comercial.",
  openGraph: {
    title: "Fine Art Free — Descarga 500.000+ Œuvres d\'art de Dominio Público",
    description:
      "Explora y descarga 500.000+ pinturas clásicas gratis. Arte de dominio público de los mejores musées del mundo. Gratis para uso personal y comercial.",
    ...
    <div>
      ...
      <section className="relative w-full bg-[#1a1a1a] py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 text-left">
          ...
          <form action="/fr/recherche" method="get" className="mt-14 max-w-3xl md:mt-16">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2">
              {safeFeaturedArtists.map((artist) => {
                ...
                return (
                  <Link
                    key={artist.name}
                    href={`/fr/artistes/${slugify(artist.name)}`}
