...
export default async function MuseumPage({ params, searchParams }: MuseumPageProps) {
  ...
  const [{ artworks, totalCount, error }, topArtists] = await Promise.all([
    fetchMuseumArtworks(museum.name, from, to, "fr"),
  ...
  return (
    <div className="space-y-8 px-5">
      ...
      />
      <MuseumGuideBanner museumSlug={slug} museumName={museum.name} locale="fr" />
      <MuseumTopArtists artists={topArtists} heading={t.topArtists} locale="fr" />
