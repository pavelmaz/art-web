...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://fineartfree.com/es",
    languages: {
    ...
    <div>
      ...
      <section className="relative w-full bg-[#1a1a1a] py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 text-left">
          ...
          <form action="/es/buscar" method="get" className="mt-14 max-w-3xl md:mt-16">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2">
              {safeFeaturedArtists.map((artist) => {
                ...
                return (
                  <Link
                    key={artist.name}
                    href={`/es/artistas/${slugify(artist.name)}`}
