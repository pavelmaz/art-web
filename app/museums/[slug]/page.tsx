...
export async function generateMetadata({ params }: MuseumPageProps): Promise<Metadata> {
  ...
  const title = `${museumName} Collection — Free Art Downloads | Fine Art Free`;
  const description = `Explore ${totalCount} artworks from ${museumName} free to download. High-resolution public domain art for any purpose.`;
