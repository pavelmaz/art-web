...
export async function generateMetadata({ params }: ArtistPageProps): Promise<Metadata> {
  ...
  const title = `${artist.name} — Complete Works Free to Download | Fine Art Free`;
...
export default async function ArtistPage({ params, searchParams }: ArtistPageProps) {
  ...
  if (error) {
    console.error("[ArtistPage]", slug, artistName, error);
  ...
  const bio = getArtistBioForLocale(artist, "en");
