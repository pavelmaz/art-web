                  ...
                  <>
                    <div className="flex justify-center">
                      <div className="relative w-fit max-w-full">
                        ...
                        pinAttrs={buildArtworkPinAttrs(artwork, "de", absoluteUrl(`/de/artworks/${slug}`))}
                        />
                        <ArtworkInsightsOverlay />
                      </div>
                    </div>
          ...
          <aside className="w-full lg:w-80">
            <div className="glass-surface space-y-4 rounded-2xl p-5 lg:sticky lg:top-6">
              ...
              <div className="space-y-3">
                ...
                <ProDownloadRow locale="de" isPro={isPro} downloadHref={maxDownloadHref} filename={artwork.slug} glass />
              </div>
