          ...
          <aside className="w-full lg:w-80">
            <div className="glass-surface space-y-4 rounded-2xl p-5 lg:sticky lg:top-6">
              <div>
                ...
                {artistSlug ? (
                  <Link href={`/ru/artists/${artistSlug}`} className="text-sm text-[#6b6b6b] hover:text-[#1a1a1a]">
                    {artist}
                  </Link>
                ) : (
              ...
              <div className="space-y-3">
                ...
                <ProDownloadRow locale="ru" isPro={isPro} downloadHref={maxDownloadHref} glass />
              </div>
