    ...
    <article className="py-8">
      ...
      <div className="mx-auto max-w-7xl px-5">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
          <aside className="order-2 w-full lg:w-96">
            <div className="glass-surface space-y-4 rounded-2xl p-5 lg:sticky lg:top-6">
              ...
              <div className="space-y-3">
                ...
                <ProDownloadRow locale="ru" isPro={isPro} downloadHref={maxDownloadHref} filename={artwork.slug} glass maxDims={artworkMaxSpecs(artwork)} maxSize={artworkMaxSize(artwork)} />
              </div>
          ...
          <ArtworkInsightsProvider artwork={artwork} locale="ru" isPro={isPro}>
