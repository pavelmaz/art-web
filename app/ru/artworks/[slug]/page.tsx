...
async function getArtworkBySlug(slug: string): Promise<ArtworkRow | null> {
  const selectColumns =
    "id, slug, title, artist_display, url, image_id, museum, style_title, genre_title, medium_display, date_display, dimensions, description, description_ru";
  ...
  return (
    <article className="bg-[#faf9f7] py-8">
      <div className="mx-auto max-w-7xl px-5">
        <ArtworkJsonLd artwork={artwork} pageUrl={`https://fineartfree.com${artworkDetailPath("ru", artwork.slug)}`} inLanguage="ru" />
